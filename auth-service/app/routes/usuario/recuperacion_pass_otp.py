...
def refresh_token():
    ...
    try:
        ...
        status,mensaje,resultado,code = usuario_service.rotar_refresh_token(session, jti_refresh_anterior, ComponentRequest.get_user_agent(), ComponentRequest.get_ip())
